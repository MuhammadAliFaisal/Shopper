...
function CartItems() {
    const {all_product,addToCart,removeFromCart,cartItems,getTotalCartAmount} = useContext(ShopContext)
  return (
    <div className='cartitems'>
        ...
        <hr />
        {all_product.map((e)=>{    
            if(cartItems[e.id]>0){      //cartitems[jo bi product p click kra ho uski id] > pehle se koi product hai
                    return <div>
